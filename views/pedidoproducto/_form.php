      ...
      <div class="col-md-4">
                ...
                <h1 class="text-center"><?= Html::encode('Vendedor: '.$usuario->nombre) ?></h1>
                  ...
                  <?= $form->field($model1, 'idproducto')->widget(Select2::classname(), [
                             ...
                             'options' => [
                             'placeholder' => 'Selecciona un codigo...','id'=>'idproducto'],
							               'pluginOptions' => [
                                 'allowClear' => true,
                                'class'=>'form-control'],
                            ])->label('Codigo producto '); ?>

    <?= $form->field($model1, 'descripcion')->textInput(['placeholder'=>'Descripcion producto']) ?>
...
$('#idproducto').change(function(){
  var prod=$(this).val();
  $.get('index.php?r=producto/getbuscadescrip',{prod:prod },function(data){
  var data=$.parseJSON(data);
    //alert(data);
    $('#pedidoproducto-descripcion').attr('value',data.descripcion);
    //se puede poner todos los combos dependientes de la misma tabla
  });
